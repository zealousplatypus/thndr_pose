...
DEFAULT_TRAIN_FRACTION = 0.97
DEFAULT_VAL_FRACTION = 0.015
DEFAULT_TEST_FRACTION = 0.015
...
DEFAULT_ESM_MODEL_NAME = "esmc_300m"
DEFAULT_ESM_DTYPE = "float32"
DEFAULT_ESM_TRUNCATE_TO = None
DEFAULT_ESM_BATCH_SIZE = 10